...
namespace Resonalyze
{
    ...
    public sealed class NoiseMeasurement : IDisposable
    {
        ...
        /// <summary>Regenerated by <see cref="Init"/>; spatial-average captures share one level offset only within one id (hardware gain changes are invisible to it).</summary>
