...
public sealed class PROptTests
{
    ...
    public void ManualTauEstimate_UsesSelectedFdwSpectrum()
    {
        ...
        var options = new FrequencyResponseOptions
        {
            ...
            // Auto would re-snap the offset to the estimated start and shift τ.
        ...
        // Guard: fixed and FDW τ differ by ~3.5e-6 ms here (sub-transition band), above the 1e-9 path-check precision.
