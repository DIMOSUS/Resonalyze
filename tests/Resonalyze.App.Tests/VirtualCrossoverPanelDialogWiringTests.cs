...
/// <summary>The panel's menus and dialogs driven through a live panel; the AI menu, which swaps the clipboard, is
/// <see cref="VirtualCrossoverPanelAiMenuWiringTests"/>. The rules have their own tests; these pin the
