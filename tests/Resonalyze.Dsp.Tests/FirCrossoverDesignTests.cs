...
/// <summary>Linear-phase crossover kernels: symmetric, constant group delay, matched pairs sum to a pure delay, slopes land once long enough.</summary>
public sealed class FirCrossoverDesignTests
{
    ...
    {
        // Exact at any length: the window is 1 at the centre and multiplies ideal responses that add to a unit impulse.
    ...
    {
        // Closed-form LR/Butterworth magnitudes must equal the section lists wherever those exist.
    ...
    public void SlopesPastTheHardwareList_AreDesigned_AndSteep(CrossoverFilterFamily family, int slope)
    {
        ...
        // The bilinear transform compresses the octave: a few dB more at 4 kHz (2.8 dB measured at 48 kHz).
    ...
    public void ADesignThatCannotBeBuilt_SaysWhy()
    {
        ...
        // The windowed sinc reads only the corner.
