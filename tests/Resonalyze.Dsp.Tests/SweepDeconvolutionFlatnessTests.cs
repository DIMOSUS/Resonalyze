...
/// <summary>Round-trip flatness of <see cref="SweepAnalysis.DeconvolveWithInverseFilter"/>: pins the 2/N normalization and the
/// inverse filter's envelope compensation. The sweep mirrors ExponentialSineSweep (app project, not referenceable).</summary>
public sealed class SweepDeconvolutionFlatnessTests
{
    ...
    public void UnityRoundTrip_IsFlatInBand()
    {
        ...
        // Skip the fade-in octave and the top of the range.
        ...
        // Pins level too: a flat but shifted response is still a regression.
    ...
    private static GeneratedSweep GenerateSweep(int octaves, double requestedDuration, int sampleRate)
    {
        ...
        // Instantaneous angular frequency is the phase's derivative in i.
